  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all duration-500 dark:-rotate-90 dark:scale-0 group-hover:text-green-400" />
      ...
      <DropdownMenuContent align="end" className="animate-fade-in bg-gray-900 border-gray-800">
        ...
        >
          <Sun className="h-4 w-4 text-green-500 group-hover:rotate-90 transition-transform duration-300" />
          <span className="group-hover:text-green-500 transition-colors">Light</span>
          {theme === 'light' && <Sparkles className="h-3 w-3 text-green-500 ml-1 animate-pulse" />}
        </DropdownMenuItem>
        <DropdownMenuItem 
          onClick={() => setTheme("dark")} 
          className="cursor-pointer group flex items-center gap-2 hover:bg-gray-800"
        >
          <Moon className="h-4 w-4 text-green-400 group-hover:rotate-12 transition-transform duration-300" />
          <span className="group-hover:text-green-400 transition-colors">Dark</span>
          {theme === 'dark' && <Sparkles className="h-3 w-3 text-green-400 ml-1 animate-pulse" />}
        </DropdownMenuItem>
        <DropdownMenuItem 
