    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="outline" 
          size="icon" 
          className="rounded-full bg-background/10 backdrop-blur-sm border-white/10 hover:bg-white/10 hover:border-green-500/50 transition-all duration-300 hover:rotate-12 group"
        >
      ...
      <DropdownMenuContent align="end" className="animate-fade-in">
        ...
        <DropdownMenuItem 
          ...
          className="cursor-pointer group flex items-center gap-2"
        >
          <Moon className="h-4 w-4 text-blue-400 group-hover:rotate-12 transition-transform duration-300" />
          <span className="group-hover:text-blue-400 transition-colors">Dark</span>
          {theme === 'dark' && <Sparkles className="h-3 w-3 text-blue-400 ml-1 animate-pulse" />}
        </DropdownMenuItem>
        <DropdownMenuItem 
