...
const SignUp: React.FC<SignUpProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative">
      {/* Top wave pattern - reduced height and adjusted position */}
      ...
      {/* Bottom wave pattern - reduced height and adjusted position */}
          ...
          >
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <Input
                ...
                className="h-11 bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 rounded-lg"
                required
              />
              <Input
                type="email"
